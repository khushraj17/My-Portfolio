...
const MISSIONS = [
  {
    ...
    description: 'A real-time system to detect deepfake videos using deep learning and computer vision.',
  ...
  {
    id: '02',
    name: 'India Census Dashboard',
    description: 'Interactive dashboard for analyzing Indian census data with visual insights.',
  ...
  },
  {
    ...
    description: 'Machine learning model to classify news articles into categories automatically.',
        ...
        <div ref={headerRef} className="mb-16 md:mb-24 flex flex-col md:flex-row md:items-end justify-between border-b border-white/10 pb-8">
          <div className="max-w-2xl">
            <h2 className="text-4xl md:text-5xl lg:text-[4.5rem] font-bold tracking-tighter text-white font-sans leading-none drop-shadow-lg mb-4">
              AI <span className="font-serif italic font-light opacity-80 text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-white pr-2">Projects</span>
            </h2>
          </div>
          <p className="text-gray-400 font-light tracking-wide text-base md:text-lg max-w-sm mt-6 md:mt-0 leading-relaxed md:text-right">
           Real-world projects built using AI, Machine Learning and data-driven techniques.
          </p>
        </div>
