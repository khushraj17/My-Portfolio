...
import imgSpiderman from '../assets/spiderman/spimg.png';
import imgMan from '../assets/man/im5.png';
        ...
        <div ref={textContainerRef} className="flex flex-col justify-center space-y-10">
          ...
          <div className="overflow-hidden">
            <h2 className="stagger-reveal text-5xl md:text-6xl font-bold tracking-tighter text-white font-sans leading-tight">
              Who Am
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-purple-500 font-serif italic pr-4"> I?</span>
            </h2>
          </div>
          <div className="overflow-hidden">
            <p className="stagger-reveal text-lg md:text-xl text-gray-400 font-light leading-relaxed max-w-xl">
              Every impactful data-driven system has two sides—the rigorous logic of data processing and modeling, and the clarity of insight communication.
              As a Data Science enthusiast, my strength lies in bridging that gap—transforming complex data, algorithms, and models into meaningful insights, and presenting them in a way that drives clear, informed, and effective decision-making.   </p>
          </div>
          ...
          <div className="overflow-hidden mt-6">
            <blockquote className="stagger-reveal border-l-2 border-red-500/50 pl-6 py-2">
              <p className="text-xl md:text-2xl text-gray-200 font-serif italic">
                “Data tells the story.  <br /> AI brings it to life.”
              </p>
            </blockquote>
          </div>
